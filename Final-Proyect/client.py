...
# This part of the client check if when json=1 is NOT selected
...
conn.request("GET", "/karyotype?specie=human")
...
conn.request("GET", "/chromosomeLength?specie=mouse&chromo=10")
